...
try {
    ...
    $mail->Body    = "Hello Dear!!". "\xA"."It's From our pleasure to notifiy that we have a new product in our system which is ".$itemName." and its price per unit is ".$itemPrice." Thanks for supporting ";
